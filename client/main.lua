...
function OpenCloakroomMenu()
  ...
  if PlayerData.job.grade_name == 'recruit' then
    table.insert(elements, {label = _U('sheriff_wear'), value = 'cadet_wear'})
  end
  ...
  if PlayerData.job.grade_name == 'boss' then
    table.insert(elements, {label = _U('sheriff_wear'), value = 'commandant_wear'})
  end
  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_sheriffjob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_sheriffjob:getVehicleInfos', function(infos)
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlPressed(0, Keys['F6']) and not isDead and PlayerData.job ~= nil and PlayerData.job.name == 'sheriff' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'sheriff_actions') and (GetGameTimer() - GUI.Time) > 150 then
